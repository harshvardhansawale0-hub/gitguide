-- ============================================================
-- GitGuide – Relational Database Schema (SQL)
-- DBMS Mini-Project / Production Schema
...
CREATE TABLE IF NOT EXISTS articles (
    ...
    keywords TEXT, -- JSON Array of string keywords
...
CREATE TABLE IF NOT EXISTS git_commands (
    ...
    name VARCHAR(100) NOT NULL UNIQUE,
    description TEXT NOT NULL,
    flags TEXT, -- JSON Array of flag objects {flag, description, dangerous, hasValue, placeholder}
